...
import guru.sfg.beer.order.service.sm.action.BeerOrderValidationAction;
...
public class BeerOrderStateMachineConfig extends StateMachineConfigurerAdapter<BeerOrderStatusEnum, BeerOrderEventEnum> {
    ...
    private BeerOrderValidationAction validationActon;
    ...
    public void configure(StateMachineTransitionConfigurer<BeerOrderStatusEnum, BeerOrderEventEnum> transitions)
            throws Exception {
        transitions
                .withExternal().source(BeerOrderStatusEnum.NEW).target(BeerOrderStatusEnum.NEW)
                    .event(BeerOrderEventEnum.VALIDATE_ORDER).action(validationActon)
                .and()
